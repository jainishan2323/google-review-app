...
export function FireflyLogo({ size = 24 }: { size?: number }) {
  return (
    <>
      <style>{`
        @keyframes jff-f-float {
          0%, 100% { transform: translateY(0px) rotate(-1deg); }
          50%       { transform: translateY(-4px) rotate(1deg); }
        }
        @keyframes jff-f-glow {
          0%, 100% {
            filter: drop-shadow(0 0 3px #feff00) drop-shadow(0 0 8px #ffe000);
          }
          50% {
        ...
        .jff-f-wrap { display: inline-block; animation: jff-f-float 3.5s ease-in-out infinite; }
        .jff-f-ring { animation: jff-f-glow 2.4s ease-in-out infinite; }
      `}</style>

      <span className="jff-f-wrap">
        <svg
          width={size}
          height={size}
          viewBox="0 0 300 300"
        ...
        >
          <defs>
            <linearGradient id="jff-f-wg1" gradientUnits="userSpaceOnUse"
              gradientTransform="translate(-42.60414,44.764628)"
              x1="83.291481" y1="144.63643" x2="-9.9875755" y2="148.8064">
              <stop offset="0" stopColor="#ff9900" stopOpacity="1" />
              <stop offset="1" stopColor="#feff00" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="jff-f-wg2" gradientUnits="userSpaceOnUse"
              gradientTransform="matrix(1.0859827,0,0,1.0129092,2.9965408,31.031408)"
              x1="21.454363" y1="173.84612" x2="-87.64196" y2="163.78394">
              <stop offset="0" stopColor="#feff00" stopOpacity="0.61" />
              <stop offset="1" stopColor="#feff00" stopOpacity="0" />
            </linearGradient>
            <radialGradient id="jff-f-spot" gradientUnits="userSpaceOnUse"
              cx="-16.997471" cy="220.97517" r="9.9322033">
              <stop offset="0" stopColor="#ffff06" stopOpacity="1" />
              <stop offset="1" stopColor="#ffff06" stopOpacity="0" />
            </radialGradient>
            <filter id="jff-f-blur" colorInterpolationFilters="sRGB">
          ...
          <g transform="matrix(1.294053,0,0,1.294053,-21.5322,-64.805303)">
            <g transform="translate(183.47923,-84.277541)">
              ...
              <path opacity="0.229" fill="url(#jff-f-spot)" transform="matrix(1.203125,0,0,1.203125,-70.440389,-111.8757)"
                d="m -6.518,223.164 c 0,5.485 -4.447,9.932 -9.932,9.932 -5.485,0 -9.932,-4.447 -9.932,-9.932 0,-5.485 4.447,-9.932 9.932,-9.932 5.485,0 9.932,4.447 9.932,9.932 z" />
            </g>
            <g transform="translate(183.47923,-84.277541)">
              <path fill="#660806" transform="matrix(1.203125,0,0,1.203125,-90.82261,-97.082338)"
                d="m -6.518,223.164 c 0,5.485 -4.447,9.932 -9.932,9.932 -5.485,0 -9.932,-4.447 -9.932,-9.932 0,-5.485 4.447,-9.932 9.932,-9.932 5.485,0 9.932,4.447 9.932,9.932 z" />
              <path opacity="0.229" fill="url(#jff-f-spot)" transform="matrix(1.203125,0,0,1.203125,-90.82261,-97.082338)"
                d="m -6.518,223.164 c 0,5.485 -4.447,9.932 -9.932,9.932 -5.485,0 -9.932,-4.447 -9.932,-9.932 0,-5.485 4.447,-9.932 9.932,-9.932 5.485,0 9.932,4.447 9.932,9.932 z" />
            </g>
            <path fill="#660806"
            ...
            <g transform="translate(177.47923,-96.277541)">
              ...
              <path opacity="0.628" fill="url(#jff-f-wg1)"
              ...
              <path opacity="0.740" fill="url(#jff-f-wg2)" filter="url(#jff-f-blur)"
